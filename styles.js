...
// Module
exports.push([module.i, "body {\n  margin: 0;\n  padding: 0;\n  background-color: #181A1B;\n  font-family: \"Montserrat\", sans-serif;\n}\n\n::-webkit-scrollbar {\n  display: none;\n}\n\n::-webkit-scrollbar-thumb {\n  display: none;\n}\n\n#model-container {\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: calc(100vw - 80px);\n  height: calc(100vh - 40px);\n  margin: 20px 40px;\n  background-color: #fff;\n  border-radius: 10px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n\n#model-close-button {\n  position: fixed;\n  top: 25px;\n  right: 50px;\n  height: 30px;\n  width: 30px;\n  cursor: pointer;\n}\n\ncanvas {\n  cursor: grab;\n}", "",{"version":3,"sources":["styles.scss"],"names":[],"mappings":"AAAA;EACE,SAAA;EACA,UAAA;EACA,yBAAA;EACA,qCAAA;AACF;;AAEA;EACE,aAAA;AACF;;AAEA;EACE,aAAA;AACF;;AAEA;EACE,eAAA;EACA,MAAA;EACA,OAAA;EACA,yBAAA;EACA,0BAAA;EACA,iBAAA;EACA,sBAAA;EACA,mBAAA;EAEA,aAAA;EACA,mBAAA;EACA,uBAAA;AAAF;;AAGA;EACE,eAAA;EACA,SAAA;EACA,WAAA;EAEA,YAAA;EACA,WAAA;EACA,eAAA;AADF;;AAIA;EACE,YAAA;AADF","file":"styles.scss","sourcesContent":["body {\n  margin: 0;\n  padding: 0;\n  background-color: #181A1B;\n  font-family: 'Montserrat', sans-serif;\n}\n\n::-webkit-scrollbar {\n  display: none;\n}\n\n::-webkit-scrollbar-thumb {\n  display: none;\n}\n\n#model-container {\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: calc(100vw - 80px);\n  height: calc(100vh - 40px);\n  margin: 20px 40px;\n  background-color: #fff;\n  border-radius: 10px;\n\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n\n#model-close-button {\n  position: fixed;\n  top: 25px;\n  right: 50px;\n\n  height: 30px;\n  width: 30px;\n  cursor: pointer;\n}\n\ncanvas {\n  cursor: grab;\n}"]}]);
// Exports
